...
export const defaultExpenseCategories: Category[] = [
  ...
  { id: 'exp_personal', name: 'Personal Care', icon: 'face-man-profile', color: '#7BED9F' },
...
export const defaultIncomeCategories: Category[] = [
  ...
  { id: 'inc_business', name: 'Business/Freelance', icon: 'laptop', color: '#2E86DE' },
  { id: 'inc_gift', name: 'Gift/Received', icon: 'gift', color: '#FF9F43' },
  { id: 'inc_interest', name: 'Interest/Returns', icon: 'trending-up', color: '#1DD1A1' },
